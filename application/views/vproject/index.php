<a href="<?php echo site_url('croject/tambah'); ?>" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>
    Tambah</a>
<hr>
        ...
        $("#konfirmasi").click(function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                    location.href = "<?php echo site_url('cproject/index/delete_success'); ?>";
                }
            });
        });
    });
